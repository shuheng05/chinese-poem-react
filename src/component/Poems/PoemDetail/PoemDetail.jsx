...
import PoemWithPinyin from "./PoemWithPinyin/PoemWithPinyin.jsx";
import './PoemDetail.css'
import {DotLottieReact} from "@lottiefiles/dotlottie-react";
import {NavLink, useNavigate} from "react-router-dom";
import Video from "../../common/Video/Video.jsx";
import pinyinjson from './data/pinyin.json'
import langdujson from './data/langdu.json'
import shangxijson from './data/shangxi.json'
import shipingjson from './data/shiping.json'
import shiyijson from './data/shiyi.json'
import dianzan from './img/dianzan.png'
import yidianzan from './img/yidianzan.png'
import cai from './img/cai.png'
import yicai from './img/yicai.png'
import shoucang from './img/shoucang.png'
import yishoucang from './img/yishoucang.png'
...
function PoemDetail({poem}) {
    ...
    /*    const search = () => {
            axios.get('/ai', {
                params: {
                    userInput: '对' + poem.title + '进行释义'
                }
            })
                .then(function (response) {
                    console.log(response);
                    setShiyi(response.data)
                })
    ...
    return (
        <div>
            ...
            <PoemWithPinyin content={poem.content} showPinyin={showPinyin}/>
