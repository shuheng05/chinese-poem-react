...
function Signup(props) {
    ...
    return (
        <div>
            {contextHolder}
            <div className={flag ? "containerSignup a-container" : "containerSignup a-container is-txl"} id="a-container">
                <form className="form" id="a-form">
                    {/*onSubmit={signup}*/}
                    <h2 className="form_title titleSignup">Create Account</h2>
                    ...
                    <input className="form__input" type="text" placeholder="Name" onChange={(event) => {
                        setName(event.target.value)
                    }}/>
                    <input className="form__input" type="text" placeholder="Email" onChange={(event) => {
                        setEmail(event.target.value)
                    }}/>
                    <input className="form__input" type="password" placeholder="Password  >=8位，至少包含英文字母与数字" onChange={(event) => {
                        setPassword(event.target.value)
                    }}/>
                    <div className="form_code_div">
                    <input className={'form_code_input'}   type="text" placeholder="code" onChange={(event) => {
                        setCode(event.target.value)
                    }}/>
                        <button className="form_code_button" onClick={getCode}>获取验证码</button>
                    </div>
                    <button className="form__button button submit" onClick={signup}>SIGN UP</button>
                </form>
