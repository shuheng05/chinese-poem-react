...
function Signin(props) {
    ...
    return (
        <div>
            {contextHolder}
            <div className={flag ? "containerSignin b-container" : "containerSignin b-container is-txl is-z200"} id="b-container">
                <form className="form" id="b-form" onSubmit={signin}>
                    <h2 className="form_title titleSignin">Sign in to Website</h2>
                    ...
                    <input className="form__input" type="password" placeholder="Password" onChange={(event) => {
                        setPassword(event.target.value)
                    }}/>
                    {/* eslint-disable-next-line jsx-a11y/anchor-is-valid */}
                    {/*<Link to="/retrievePassword" className="form__link">Forgot your password?</Link>*/}
